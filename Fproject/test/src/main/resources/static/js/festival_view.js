...
function makeMap(){
    ...
    //        center: new kakao.maps.LatLng(37.659539,  126.772712), // 지도의 중심좌표
            level: 3 // 지도의 확대 레벨
        };
...
function traceMarker(){
     ...
     dkpos1 = new kakao.maps.LatLng(y, x);

                // 툴팁을 노출하는 마커를 생성합니다.
                 marker1 = new TooltipMarker(dkpos1, 'kakao 본사');
                marker1.setMap(map);
                // MarkerTracker를 생성합니다.
                 markerTracker1 = new MarkerTracker(map, marker1);
